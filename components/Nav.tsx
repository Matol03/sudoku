  ...
  return (
    ...
    >
        ...
        {NAV_LINKS.map(({ href, label }) => {
          ...
          return (
            <Link
              key={href}
              href={href}
              className="relative px-3 py-1.5 text-sm rounded-md outline-none"
              style={{
      ...
      <div className="flex items-center gap-2">
        <Link
          href="/pricing"
          className="hidden sm:flex items-center px-3 py-1.5 text-sm rounded-[var(--radius-btn)] font-medium"
          style={{
        ...
        <Link
          href="/login"
          className="px-3 py-1.5 text-sm rounded-[var(--radius-btn)]"
